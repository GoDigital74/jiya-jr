...
//       {/* 👇 FIX: Increased max-w-7xl to max-w-[1400px] so the whole row can stretch wider and make images bigger */}
...
//                 {/* 👇 FIX: Changed aspect-[4/3] to aspect-[5/4] to make them a little bit taller/larger vertically */}
//                 <div className="relative overflow-hidden rounded-3xl lg:rounded-xl bg-[#F0F0F0] border border-gray-200 w-full aspect-[5/4] flex items-center justify-center mb-6 transition-all duration-300 group-hover:shadow-2xl group-hover:border-[#D4AF37]">
//                   <Image 
//                     src={item.src}
//                     alt={item.alt}
//                     fill 
