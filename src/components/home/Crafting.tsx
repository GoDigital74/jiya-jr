...
export default function Crafting() {
  return (
    <section className="w-full bg-white py-2 lg:py-16">
      <div className="container mx-auto px-2 lg:px-12 max-w-[1400px]">
        <motion.div
        ...
        >
          <Image
            src="/banner 4.png" // Pointing to the image in your public folder
            alt="Why Choose Jiya JR - Quality, Trust, Excellence"
            width={1920}
            height={600}
            unoptimized
            sizes="(max-width: 768px) 100vw, (max-width: 1200px) 100vw, 1400px"
            // 👇 FIX: Changed to aspect-[2.5/1] for desktop to show a little more height
