...
//     if (searchQuery.trim()) {
//       setIsSearchFocused(false);
//       // 👇 FIX: Use window.location to force a hard refresh so filters clear
...
//                 {/* 👇 FIX: If the link is "Collection", use a standard <a> tag to force a hard refresh when clicked */}
...
//                         // 👇 FIX: Use a standard <a> tag for dropdown items to force a hard refresh
//                         <a
//                           key={dropLink.name}
//                           href={dropLink.href}
