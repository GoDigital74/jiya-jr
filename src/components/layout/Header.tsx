...
// //   // Removed destructuring of potentially buggy 'subtotal' from store
...
// //   // Dynamically calculate cart count and total price
...
// //   // Redirect to the Cart page to review added products
// //   const handleGoToCart = () => {
// //     setIsCartOpen(false); // Close the drawer
// //     router.push("/cart"); // Send the user to the cart/checkout page
// //   };
...
// //                 className="text-sm font-semibold text-gray-700 hover:text-[#D4AF37] transition-colors relative group whitespace-nowrap"
// //               >
// //                 {link.name}
...
//   // 👇 FIX: Updated to precisely match the categories in your sidebar
//   const navLinks = [
//     { name: "Home", href: "/" },
//     { name: "About Us", href: "/about" },
//     { 
...
//       href: "/shop",
//       dropdown: [
//         { name: "School", href: "/shop?category=School+Award" },
//         { name: "Business", href: "/shop?category=Business+Award" },
//         { name: "Regular", href: "/shop?category=Regular+Award" },
