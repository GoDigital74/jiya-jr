        ...
        <div className="container mx-auto px-4 lg:px-12 max-w-4xl">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 md:p-14 text-center mb-8">
            ...
            <p className="text-gray-700 max-w-2xl mx-auto">
              At Jiya JR, we are committed to delivering your orders safely and
              on time. We work with trusted courier partners to ensure a smooth
              shipping experience.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-10">
              <h2 className="flex items-center gap-3 text-xl font-bold text-gray-900 mb-6">
                <Truck className="w-6 h-6 text-[#D4AF37]" /> Estimated Delivery
                Time
              </h2>
              ...
              <p className="text-sm italic text-gray-500 text-center">
                * Delivery timelines are estimates and may be affected by
                weather conditions, courier delays, or festivals.
              </p>
            </section>

            <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-10">
              <h2 className="flex items-center gap-3 text-xl font-bold text-gray-900 mb-6">
                <MapPin className="w-6 h-6 text-[#D4AF37]" /> Coverage &
                Restrictions
              </h2>
              <ul className="space-y-4 text-gray-600">
                <li className="flex gap-4">
                ...
                <li className="flex gap-4">
                  ...
                  details. We are not responsible for delays due to incorrect
                  addresses.
                </li>
