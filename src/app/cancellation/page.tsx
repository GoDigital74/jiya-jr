        ...
        <div className="container mx-auto px-4 lg:px-12 max-w-4xl">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 md:p-14 text-center mb-8">
            ...
            <p className="text-gray-700 max-w-3xl mx-auto">
              At Jiya JR, we begin processing orders immediately after they are
              placed to ensure timely dispatch to you.
            </p>
          </div>
          ...
          <div className="space-y-6">
            <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-10">
              <h2 className="flex items-center gap-3 text-2xl font-bold text-gray-900 mb-6">
                <XCircle className="w-8 h-8 text-red-500" /> Strict No
                Cancellation Policy
              </h2>

              <div className="bg-red-50 text-red-800 p-6 md:p-8 rounded-xl border border-red-100 mb-8 text-lg font-medium text-center">
                Once an order has been successfully placed, it cannot be
                cancelled, modified, or changed under any circumstances.
              </div>
              ...
              <div className="space-y-6 text-gray-600">
                <div className="flex gap-4 bg-gray-50 p-6 rounded-xl border border-gray-100">
                  ...
                  <p>
                    We request all customers to carefully review their order
                    details, shipping address, contact information, and selected
                    products <strong>before</strong> completing the purchase.
                  </p>
                </div>

                <p className="px-2">
                  As we start processing orders immediately upon receipt,
                  cancellation requests made via email, phone, or any other
                  communication channel will not be accepted.
                </p>
              </div>
            </section>
