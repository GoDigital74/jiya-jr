      ...
      <div className="bg-[#f9f9f9] min-h-screen pt-28 md:pt-32 pb-12 font-sans">
        <div className="container mx-auto px-4 lg:px-8 max-w-[1600px]">
          ...
          <div className="lg:hidden flex items-center justify-between bg-white p-4 rounded-lg shadow-sm mb-6 border border-gray-100">
            {/* 👇 FIX: Sort moved to the left */}
            <div className="flex items-center gap-2 text-sm font-bold text-gray-800 uppercase tracking-wider relative flex-1 justify-center">
              <select
            ...
            <button
              ...
              className="flex items-center gap-2 text-sm font-bold text-gray-800 uppercase tracking-wider flex-1 justify-center"
            >
